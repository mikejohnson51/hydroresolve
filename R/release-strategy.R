...
#' Create Release
#' @param fl flowlines sf object
#' @param cat catchment sf object
#' @param dir output directory
#' @param version named release versions
#' @importFrom dplyr select mutate left_join 
#' @importFrom sf st_drop_geometry st_area st_transform st_as_sf st_filter st_join write_sf st_make_valid 
